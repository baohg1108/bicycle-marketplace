...
class OrderService
{
    public static function storeOrder(string $paymentId, float $paidAmount, string $paymentMethod, string $currency, float $currencyRate, string $paymentStatus)
    {
        ...
        foreach ($groupProductByStore as $store) {
            ...
            if (Session::has('coupon') && isset(Session::get('coupon')['discount'])) {
