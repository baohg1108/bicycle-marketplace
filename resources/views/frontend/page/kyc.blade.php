                            ...
                            <div class="login_wrap widget-taber-content background-white">
                                <div class="padding_eight_all bg-white">
                                    ...
                                    <form method="post" action="{{ route('login') }}">
                                        ...
                                        <div class="form-group">
                                            <label for="" class="form-weight-bold">Gender <span
                                                    class="text-danger">*</span></label>
                                        ...
                                        <div class="form-group">
                                            <label for="" class="form-weight-bold">Full address <span
                                                    class="text-danger">*</span></label>
                                        ...
                                        <div class="form-group">
                                            <label for="" class="form-weight-bold">Document type <span
                                                    class="text-danger">*</span></label>
                                        ...
                                        <div class="form-group">
                                            <label for="" class="form-weight-bold">Document scan copy <span
                                                    class="text-danger">*</span></label>
                                            <label for="" class="form-weight-bold">Document Scan Copy <span
                                                    class="text-danger">*</span></label>
