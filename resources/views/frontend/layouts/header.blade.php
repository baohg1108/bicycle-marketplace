         ...
         <div class="container">
             <div class="header-wrap">
                 <div class="logo logo-width-1">
                     <a href="index.html">
                         <img src="{{ asset('assets/frontend/dist/imgs/icons/logo.png') }}" alt="logo"
                     ...
                     <div class="search-style-2">
                         <form action="#">
                             <select class="select-active">
                                 ...
                                 <option>Áo</option>
                                 <option>Balo - Túi</option>
                                 <option>Găng Tay</option>
                                 <option>Giày</option>
                                 <option>Mắt Kính</option>
                     ...
                     <div class="header-action-right">
                         <div class="header-action-2">
                             <div class="header-action-icon-2">
                                 <a href="#">
                                     <img class="svgInject" alt="ShopX"
                                         src="{{ asset('assets/frontend/dist/imgs//icons/icon-compare.svg') }}" />
                             ...
                             <div class="header-action-icon-2">
                                 <a href="#">
                                     <img class="svgInject" alt="ShopX"
                                         src="{{ asset('assets/frontend/dist/imgs/icons/icon-heart.svg') }}" />
                             ...
                             <div class="header-action-icon-2">
                                 <a class="mini-cart-icon" href="#">
                                     <img alt="ShopX"
                                         src="{{ asset('assets/frontend/dist/imgs/icons/icon-cart.svg') }}" />
                                         ...
                                         <li>
                                             <div class="shopping-cart-img">
                                                 <a href="#"><img alt="ShopX"
                                                         src="{{ asset('assets/frontend/dist/imgs/icons/thumbnail-3.jpg') }}" /></a>
                                             </div>
                             ...
                             <div class="header-action-icon-2">
                                 <a href="{{ route('login') }}">
                                     <img class="svgInject" alt="ShopX"
                                         src="{{ asset('assets/frontend/dist/imgs/icons/icon-user.svg') }}" />
                                 </a>
