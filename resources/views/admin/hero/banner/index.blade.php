...
@section('contents')
    <div class="container-xl">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.hero-banners.store') }}" method="POST" class="coupon-form"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="btn_url_one" placeholder=""
                                    value="{{ $heroBanner?->btn_url_one }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                <label class="form-label required">Action Button Url</label>
                                <input type="text" class="form-control" name="btn_url_two" placeholder=""
                                    value="{{ $heroBanner?->btn_url_two }}">
