...
@section('contents')
    <div class="container-xl">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.sliders.update', $slider) }}" method="POST" class="coupon-form"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="btn_url" placeholder=""
                        ...
                        <div class="col-md-12">
                            <div class="mb-2">
                                <label class="form-check form-switch form-switch-3">
                                    <input class="form-check-input" type="checkbox" @checked($slider->is_active)
