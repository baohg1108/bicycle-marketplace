<div class="accordion-item">
    <div class="accordion-header">
        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
            ...
            {{ $variant->name }} @if ($variant->is_default == 1)
                <span class="badge bg-primary text-white">default</span>
                @endif @if ($variant->is_active == 1)
                    ...
                    <div class="col-md-12">
                        <label class="form-check mt-3">
                            <input class="form-check-input variant-manage-stock" type="checkbox"
                                @checked($variant->manage_stock == 1) value="1" name="variant_manage_stock">
                                ...
                                <div class="d-flex gap-2">
                                    <label class="form-check">
                                        <input class="form-check-input" checked type="radio"
                                            @checked($variant->in_stock == 1) name="variant_stock_status" value="in_stock">
                                        <span class="form-check-label">In Stock</span>
                                    </label>
                                    <label class="form-check">
                                        <input class="form-check-input" type="radio" @checked($variant->in_stock == 0)
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="d-flex gap-2">
                            <label class="form-check form-switch form-switch-3">
                                <input class="form-check-input" type="checkbox" @checked($variant->is_default == 1)
                                    value="1" name="variant_is_default">
                                <span class="form-check-label">Is Default</span>
                            </label>

                            <label class="form-check form-switch form-switch-3">
                                <input class="form-check-input" type="checkbox" @checked($variant->is_active == 1)
                                    value="1" name="variant_is_active">
