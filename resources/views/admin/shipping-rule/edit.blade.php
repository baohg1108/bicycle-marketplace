            ...
            <div class="card-body">
                <form action="{{ route('admin.shipping-rules.update', $shippingRule) }}" method="POST"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <select name="type" class="form-select" id="shipping_type">
                                    ...
                                    <option @selected($shippingRule->type == 'minimum_order_amount') value="minimum_order_amount">Minimum Order Amount
                                    </option>
                                </select>
                        ...
                        <div class="col-md-12 minimum_amount"
                            style="{{ $shippingRule->type == 'flat_amount' ? 'display: none' : '' }}">
                            <div class="mb-3">
                                <label class="form-label required">Minimum Amount</label>
                                <input type="text" class="form-control" name="minimum_amount" placeholder=""
                                    value="{{ $shippingRule->minimum_amount }}">
                        ...
                        <div class="col-md-12">
                            <div class="mb-2">
                                <label class="form-check form-switch form-switch-3">
                                    <input @checked($shippingRule->is_active) class="form-check-input" type="checkbox"
                                        checked="" name="is_active" id="status" value="1">
